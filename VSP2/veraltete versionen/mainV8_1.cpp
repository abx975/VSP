        ...
        return
                {
                        [=](new_job_atom, numberToSplit nts)
                        {
                            ...
                            ////////////////////////////////
                            self->state.prev.tPrev=get_wall_time();
                            ////////////////////////////////
...
//coordinator behaviour
    behavior coordinator(stateful_actor<coordinatorState> *self)
    {
        ...
        return
                {
                        ////////////////////////////////////////////
                        [=](update_cycles_atom,double manager_cycles){
                        ...
                        {
                            ///////////////////////////////////////////////////////
                            self->state.cycles_total+=nts.cycles;
                            ...
                            if ( self->state.setOfFactors.empty())
                            {
                                if(self->state.done == false)
                                {
                                    ...
                                    stringstream s;// string Stream erzeugen
                                    s << "Number of Runs: " << self->state.num.cycles * NUM_WORKERS << endl;
                                    s << "Wall Time = " << wallTime << endl;
                                    s << "CPU Time  = " << cpuTime * NUM_WORKERS  * self->state.managers.size()<< endl;
